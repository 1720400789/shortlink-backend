...
import org.zj.shortlink.project.mq.consumer.ShortLinkStatsSaveConsumer;
...
import static org.zj.shortlink.project.common.constant.RedisKeyConstant.SHORT_LINK_STATS_STREAM_GROUP_KEY;
import static org.zj.shortlink.project.common.constant.RedisKeyConstant.SHORT_LINK_STATS_STREAM_TOPIC_KEY;
...
//    private String group;
    ...
    /**
     * 监听 Redis Stream 上的消息
     * @param asyncStreamConsumer Spring容器中的 ExecutorService 类型的 Bean
     * @return 一个监听 redis stream 消息的 Bean 实例
     */
